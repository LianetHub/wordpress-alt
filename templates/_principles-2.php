...
$company_principles_group = get_field('company_principles', $post_id);
...
?>
        <div class="principles">
            <div class="container">
                <?php if ($principles_title && $principles_description): ?>
                ...
                <?php elseif ($principles_title): ?>
                    <div class="principles__title title text-uppercase">
                        <?php echo nl2br(esc_html($principles_title)); ?>
                    </div>
                <?php elseif ($principles_description): ?>
                    <div class="principles__header">
                        <div class="principles__desc">
                            <?php echo fix_widows_after_prepositions(wp_kses_post($principles_description)); ?>
                        </div>
                ...
                <?php endif; ?>
                <ol class="principles__list principles__list--arrows">
                    <?php
