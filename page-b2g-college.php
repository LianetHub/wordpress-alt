...
<?php require_once(TEMPLATE_PATH . '_cases-b2g-college.php'); ?>
<?php require_once(TEMPLATE_PATH . '_reviews.php'); ?>
<?php require_once(TEMPLATE_PATH . '_principles-2.php'); ?>
<?php require_once(TEMPLATE_PATH . '_offer.php'); ?>
<?php require_once(TEMPLATE_PATH . '_clients.php'); ?>
<?php require_once(TEMPLATE_PATH . '_certificates.php'); ?>
